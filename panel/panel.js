  ...
  *******************************/
  ...
  /*    if(!localStorage.options) {
    ...
    */
    ...
    /**
     * Конвертация строки в "строку с 1251" для отправки посредством аякса
     * @param {string|number} string - любая строка или число
     */
    encodeDataForAjax: function(string){
      var i, length, result, charCode;
      var table1251 = {
        ...
        124:"%7C",125:"%7D",126:"%7E",127:"%7F",1026:"%80",1027:"%81",8218:"%82",1107:"%83",
        8222:"%84",8230:"%85",8224:"%86",8225:"%87",8364:"%88",8240:"%89",1033:"%8A",8249:"%8B",
        1034:"%8C",1036:"%8D",1035:"%8E",1039:"%8F",1106:"%90",8216:"%91",8217:"%92",8220:"%93",
        8221:"%94",8226:"%95",8211:"%96",8212:"%97",8482:"%99",1113:"%9A",8250:"%9B",1114:"%9C",
        1116:"%9D",1115:"%9E",1119:"%9F",160:"%A0",1038:"%A1",1118:"%A2",1032:"%A3",164:"%A4",
        1168:"%A5",166:"%A6",167:"%A7",1025:"%A8",169:"%A9",1028:"%AA",171:"%AB",172:"%AC",
        173:"%AD",174:"%AE",1031:"%AF",176:"%B0",177:"%B1",1030:"%B2",1110:"%B3",1169:"%B4",
        181:"%B5",182:"%B6",183:"%B7",1105:"%B8",8470:"%B9",1108:"%BA",187:"%BB",1112:"%BC",
        1029:"%BD",1109:"%BE",1111:"%BF",1040:"%C0",1041:"%C1",1042:"%C2",1043:"%C3",1044:"%C4",
        1045:"%C5",1046:"%C6",1047:"%C7",1048:"%C8",1049:"%C9",1050:"%CA",1051:"%CB",1052:"%CC",
        1053:"%CD",1054:"%CE",1055:"%CF",1056:"%D0",1057:"%D1",1058:"%D2",1059:"%D3",1060:"%D4",
        1061:"%D5",1062:"%D6",1063:"%D7",1064:"%D8",1065:"%D9",1066:"%DA",1067:"%DB",1068:"%DC",
        1069:"%DD",1070:"%DE",1071:"%DF",1072:"%E0",1073:"%E1",1074:"%E2",1075:"%E3",1076:"%E4",
        1077:"%E5",1078:"%E6",1079:"%E7",1080:"%E8",1081:"%E9",1082:"%EA",1083:"%EB",1084:"%EC",
        1085:"%ED",1086:"%EE",1087:"%EF",1088:"%F0",1089:"%F1",1090:"%F2",1091:"%F3",1092:"%F4",
        1093:"%F5",1094:"%F6",1095:"%F7",1096:"%F8",1097:"%F9",1098:"%FA",1099:"%FB",1100:"%FC",
        1101:"%FD",1102:"%FE",1103:"%FF"
      };
      ...
      if(typeof string == 'string' || typeof string == 'number'){
        ...
        for(i = 0, length = string.length; i < length; i++){
          ...
          if(table1251[charCode]){
            result += table1251[charCode];
          } else {
